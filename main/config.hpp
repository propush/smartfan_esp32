...
constexpr uint32_t FAN_ON_TIME_MS   = 30000;  // Fan runs for 30 seconds after button press
...
constexpr uint32_t ADC_TASK_STACK_SIZE    = 2048;
...
constexpr uint32_t FAN_TASK_STACK_SIZE    = 2048;
